...
class CategoryAssignmentService implements CategoryAssignmentServiceInterface
{
     ...
     * @inheritDoc
     *
     * NOTE: This method only finds existing categories. It does NOT create new categories.
     * If no matching category is found, it returns null and the song import should be skipped.
     */
    public function getOrCreateShowCategory(
        ...
        // Category does not exist - DO NOT create new categories
        // Songs should only be imported to existing track categories
        $this->logger->debug('No existing show category found - skipping', [
            'show' => $showIdentifier,
            'title' => $showTitle,
