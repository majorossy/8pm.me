...
/**
 * Options provider for show_venue filter
 *
 * Fetches all option values from the show_venue dropdown attribute
 */
class VenueOptions implements OptionSourceInterface
{
    ...
    public function toOptionArray(): array
    {
        if ($this->options === null) {
            $this->options = $this->getAttributeOptions('show_venue');
        }
