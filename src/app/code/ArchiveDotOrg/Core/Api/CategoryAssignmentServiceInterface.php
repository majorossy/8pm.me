...
interface CategoryAssignmentServiceInterface
{
    ...
    /**
     * Find existing category for a show/album
     *
     * NOTE: This method ONLY finds existing categories. It does NOT create new categories.
     * If no matching category is found, returns null and the song import should be skipped.
     *
     * @param string $showIdentifier
     * @param string $showTitle
     * @param int $parentCategoryId
     * @return int|null Category ID if found, null if not found
     */
