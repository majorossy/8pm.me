    ...
    >
      ...
      >
        ...
        <div className="py-2">
          ...
          <p className="text-sm text-[#a7a7a7] truncate mt-1">{url}</p>
        </div>
          ...
          {hasNativeShare && (
            ...
            >
              ...
              <div className="flex-1 text-left">
                ...
                <p className="text-sm text-[#a7a7a7]">More options</p>
              </div>
            </button>
          )}
        </div>
        ...
        <div className="pt-4 border-t border-[#404040]">
          <p className="text-xs text-[#a7a7a7] text-center mb-4">Or share on social media</p>
          <div className="flex items-center justify-center gap-4">
            ...
            >
              <svg className="w-5 h-5 text-[#b3b3b3] group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
