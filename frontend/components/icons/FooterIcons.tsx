// Inline SVG icons for footer pages
// Following the pattern established in ToastContainer.tsx
...
// Question mark circle icon - FAQ page
...
// Music note icon - For music-related sections
export const MusicNoteIcon = ({ className = 'w-6 h-6' }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
// Code icon - For technical/built-with sections
...
// User icon - For user-related sections
...
// Database/storage icon - For data/localStorage sections
...
// External link icon
export const ExternalLinkIcon = ({ className = 'w-6 h-6' }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
// Check/verified icon - For allowed lists
...
// X/cross icon - For not-allowed lists
...
// Send icon - For contact form submit
...
// Numbered step circles for How It Works page
...
// Bug report icon
export const BugIcon = ({ className = 'w-6 h-6' }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
// Playlist/list icon
export const PlaylistIcon = ({ className = 'w-6 h-6' }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
// Microphone icon - For tapers page
