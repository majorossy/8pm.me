  ...
  return (
    <header
      className={`sticky top-0 z-30 flex items-center justify-between px-8 py-4 transition-colors ${
        transparent ? 'bg-transparent' : 'bg-[#121212]/95 backdrop-blur-sm'
      }`}
    >
      {/* Navigation buttons */}
      ...
      <div className="flex items-center gap-4">
        <button className="w-8 h-8 rounded-full bg-[#282828] flex items-center justify-center text-white hover:bg-[#3e3e3e] transition-colors">
