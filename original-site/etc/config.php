...
return [
    'modules' => [
        ...
        'Rmg_AsynchronousOperations' => 1,
        'Rmg_Base' => 1,
        'Rmg_Blog' => 1,
        'Rmg_BlogGraphQl' => 1,
        'Rmg_BlogSampleData' => 1,
        'Rmg_BraintreeGraphQl' => 1,
        'Rmg_Brand' => 1,
        'Rmg_BundleGraphQl' => 1,
        'Rmg_CareGuide' => 1,
        'Rmg_Catalog' => 1,
        'Rmg_CatalogCustomerGraphQl' => 1,
        'Rmg_CatalogGraphQl' => 1,
        'Rmg_CategoryLanding' => 1,
        'Rmg_CategoryLandingGraphQl' => 1,
        'Rmg_CheckoutGraphQl' => 1,
        'Rmg_ConfigurableProductGraphQl' => 1,
        'Rmg_ContactGraphQl' => 1,
        'Rmg_Customer' => 1,
        'Rmg_CustomerBalanceGraphQl' => 1,
        'Rmg_CustomerGraphQl' => 1,
        'Rmg_DirectoryGraphQl' => 1,
        'Smile_ElasticsuiteCore' => 1,
        'Smile_ElasticsuiteCatalog' => 1,
        'Rmg_Features' => 1,
        'Rmg_GiftCardGraphQl' => 1,
        'Rmg_GiftMessage' => 1,
        'Rmg_GiftMessageGraphQl' => 1,
        'Rmg_GiftWrappingGraphQl' => 1,
        'Rmg_GraphQl' => 1,
        'Rmg_GroupedProductGraphQl' => 1,
        'Rmg_InventoryGraphQl' => 1,
        'Rmg_Jwt' => 1,
        'Rmg_MenuManager' => 1,
        'Rmg_MenuManagerGraphQl' => 1,
        'Rmg_PageBuilder' => 1,
        'Rmg_ProductAlertGraphQl' => 1,
        'Sparsh_ProductLabel' => 1,
        'Rmg_ProductLabel' => 1,
        'Rmg_QuoteBundleOptions' => 1,
        'Rmg_QuoteGraphQl' => 1,
        'Rmg_SalesGraphQl' => 1,
        'Rmg_SalesRule' => 1,
        'Rmg_SalesRuleGraphQl' => 1,
        'Rmg_SearchGraphQl' => 1,
        'Rmg_ShippingGraphQl' => 1,
        'Rmg_StoreGraphQl' => 1,
        'Rmg_SwatchesGraphQl' => 1,
        'Rmg_Theme' => 1,
        'Rmg_TokenBase' => 1,
        'Rmg_UrlRewriteGraphQl' => 1,
        'Rmg_UrlRewriteTracking' => 1,
        'Rmg_WishlistGraphQl' => 1,
        'Rmg_WishlistFixes' => 1,
        'Smile_ElasticsuiteAdminNotification' => 1,
        'Smile_ElasticsuiteTracker' => 1,
        'Smile_ElasticsuiteCatalogGraphQl' => 1,
        'Rmg_ElasticsuiteCatalog' => 1,
        'Smile_ElasticsuiteCatalogRule' => 1,
        'Smile_ElasticsuiteCatalogOptimizer' => 1,
        'Rmg_ElasticsuiteCatalogGraphQl' => 1,
    ...
    'scopes' => [
        ...
        'stores' => [
            ...
            'magento_reference' => [
                'store_id' => '2',
                'code' => 'magento_reference',
                'website_id' => '1',
                'group_id' => '1',
                'name' => 'Magento Reference Store',
                'sort_order' => '1',
                'is_active' => '1'
            ]
        ]
