            ...
            foreach($_all_tpo_make as $_a_cat){
                ...
                switch($_depth_count){
                    case 2:
                        ...
                        $category->setPageLayout('1column');
                        break;
                    case 3:
                        // An Artist
                        $_song_track_number = 0;
                        ...
                        $category->setImage('/media/catalog/category/artist_'.$_a_cat['artist_collection_rss'].'.jpg', $mediaAttribute, true, false);
                        $category->setPageLayout('empty');
                        break;
                    case 4:
                        // An Album
                        $_song_track_number = 0;
                        ...
                        $category->setImage('/media/catalog/category/artist_'.trim($_a_cat['artist_collection_rss']).'_album_'.ucwords(str_replace(' ', '', $_a_cat['name'])).'.jpg', $mediaAttribute, true, false);
                        $category->setPageLayout('empty');
                        break;
                    case 5:
                        // A Track | Song
                ...
                //$category->setPageLayout($_a_cat['page_layout']);
                ...
                $category->save();
//$this->logger->critical(category->getName);
